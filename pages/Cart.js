...
function Cart() {
  ...
  const bgColorOn =
    "px-4 py-2 mt-3 text-base font-medium text-gray-700 border border-gray-300 rounded-md shadow-sm cursor-pointer hover:bg-gray-200 hover:text-[black] bg-orange-700 text-[white]";
  const bgColorOff =
    "px-4 py-2 mt-3 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm cursor-pointer hover:bg-gray-200 focus:text-[white]";
  ...
  useEffect(() => {
    ...
    const dbRef = ref(
      db,
      "userAccounts/" + localStorage.getItem("accountKey") + "/cart"
    );
    ...
    const dbRefNew = ref(
      db,
      "userAccounts/" + localStorage.getItem("accountKey")
    );
  ...
  function registerSeatMinus(getter, setter, currentQuantity, id) {
    if (currentQuantity > 0) {
      ...
      const dbRef = ref(
        db,
        "userAccounts/" + localStorage.getItem("accountKey") + "/cart/" + id
      );
    ...
    <div>
      <div className={!loading ? "hidden" : ""}>
        <div className='fixed top-0 left-0 z-50 flex items-center justify-center w-full h-full backdrop-blur-sm backdrop-brightness-10 '>
          <div className=''>
            <iframe
              src='https://giphy.com/embed/Oarp36ygIEw6c'
              width='280'
              height='260'
              frameBorder='0'
              class='giphy-embed'
            ...
            <p>
              <a href='https://giphy.com/gifs/finally-atlast-itsover-Oarp36ygIEw6c'></a>
            </p>
          </div>
        </div>
      </div>
      <div className='flex flex-wrap '>
        <div className=' w-full sm:w-1/2 bg-[#fff] h-screen'>
          <div className='px-5 py-20 sm:p-20 '>
            <h1 className='max-w-md mb-2 text-lg font-medium text-gray-900 sm:max-w-xl '>
              My Orders
            </h1>
            <div className='pt-5'>
              {cartArray
                        ...
                        <div className='flex justify-between py-5 '>
                          ...
                          <div className='w-80'>
                            ...
                            <div className='flex items-center'>
                              <div>
                                <p className='mt-1 text-sm text-gray-500 mr-14'>
                                  Size
                                </p>
                              </div>
                              <div className='flex'>
                                <button
                                  onClick={() => {
                                    sizeUpdate(data.id, "S");
                                  }}
                                  className={
                                    data.size === "S" ? bgColorOn : bgColorOff
                                  }>
                                  S
                                </button>
                                <button
                                  onClick={() => {
                                    sizeUpdate(data.id, "M");
                                  }}
                                  className={
                                    data.size === "M"
                                      ? bgColorOn + " mx-3"
                                ...
                                <button
                                  onClick={() => {
                                    sizeUpdate(data.id, "L");
                                  }}
                                  className={
                                    data.size === "L" ? bgColorOn : bgColorOff
                                  }>
                                  L
                                </button>
                              </div>
                            ...
                            <div className='flex items-center'>
                              <div>
                                <p className='w-20 mt-1 text-sm text-gray-500'>
                                  Quantity
                                </p>
                              </div>
                              <div className='flex items-center '>
                                <button
                                  ...
                                  className='px-4 py-2 mt-3 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm cursor-pointer hover:bg-gray-200 focus:bg-gray-900 focus:text-[white]'>
                                  -
                                </button>
                                <div className='px-1 mx-7'>{data.quantity}</div>
                                <button
                                  onClick={() => {
                                    registerSeatAdd(
                                      quantity,
                          ...
                          <div className='flex flex-col justify-between '>
                            <div>
                              <h1 className='text-xl text-[#942640] font-semibold '>
                                ₱ {parseInt(data.price * data.quantity, 10)}
                              </h1>
                              <p className='text-sm text-gray-400 mr-14'>
                                ₱ {data.price} x {data.quantity}
                              </p>
                            </div>
                            <div>
                              <div
                                className=' inline-block cursor-pointer rounded-full hover:text-[#1b1b74] hover:font-semibold mt-2 py-2 '
                                onClick={() => {
                                  removeItem(data.id);
                                }}>
                                Remove
              ...
              <div className='flex justify-between'>
                ...
                <div className='w-1/2 '>
                  ...
                  <div className='flex justify-between pb-2 mt-4 text-lg font-semibold text-gray-900'>
                    <h1>Total</h1>
                    <div className='text-[green]'>₱ {total + 50}</div>
                  </div>
                  <div
        ...
        <div
          className={
            !checkoutDiv
              ? "blur-sm bg-[#f5f7fb] w-full sm:w-1/2 h-full px-10 py-20 "
              : " w-full sm:w-1/2 bg-[#f5f7fb] h-full px-10 py-20 "
          }>
          <div className='max-w-xl m-auto '>
            <div className='mb-10'>
              <h1 className='max-w-md mb-2 text-2xl font-medium text-gray-900 sm:max-w-xl '>
                Finalize Customer Details
              </h1>
              <p className='max-w-md mb-2 text-gray-500 text-md sm:max-w-xl '>
                Please complete each details
              </p>
            </div>
            <label
              htmlFor='time'
              className='block text-lg font-medium text-gray-700 text-md'>
              Select time
            </label>
            <select
              value={selectedHour}
            ...
            <div className='mt-5'>
              <label
                htmlFor='time'
                className='block mb-3 text-lg font-medium text-gray-700 text-md'>
                Input pax
              </label>
              <input
                value={pax}
            ...
            <div className={pax && selectedHour ? "block mt-5" : "hidden"}>
              ...
              <div className='my-5'>
                ...
                <div className='flex'>
                  <button
                    variant='contained'
                    className='relative px-4 py-2 text-sm font-medium text-white bg-[#b4b4b4] border border-transparent rounded-md group '
                    disableElevation>
                    Reserved
                  </button>
                  <button
                    variant='contained'
                    className='mx-5 relative px-4 py-2 text-sm font-medium text-white bg-[green] border border-transparent rounded-md group hover:bg-[#0e380e] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:bg-[#50382F]'
                    disableElevation>
                    Available
                  </button>
                </div>
              ...
              <div>
                <div name='seat' className='flex flex-wrap justify-start'>
                  {seatArray
                    ? seatArray.map((data, parentIndex) => {
                        const id = uuidv4();
                        ...
                        return (
                          <div className='m-1 max-w-fit' key={data.id}>
                            <div className='flex justify-center'>
                              <div className=''>
                                <h5 className='primary-color-text-custom '>
                                  Group {parentIndex + 1}
                                </h5>
                              </div>
                            </div>
                                        ...
                                        return (
                                          <div
                                            ...
                                            <button
                                              ...
                                              variant='contained'
                                              className='relative px-4 py-2 text-sm font-medium text-white bg-[green] border border-transparent rounded-md group hover:bg-[#0e380e] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:bg-[#50382F]'
                                              disableElevation>
                                              {index + 1}
                                            </button>
                                            {/* </Tooltip> */}
            ...
            {newData
              ? newData.map((data) => {
                  return (
                    <>
                      <h1 className='py-5 mt-4 text-gray-900 text-md line-mid'>
                        Order & Appointment Completion
                      </h1>
                      <div className='flex items-center '>
